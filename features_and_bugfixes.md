...
- [ ] add load from github repo and backup to github repo
- [ ] add dump wiki to tar or zip option
- [ ] add color customization panel in user settings that allows users to customize their own ui
- [ ] allow for s3 bucket storage optionally
